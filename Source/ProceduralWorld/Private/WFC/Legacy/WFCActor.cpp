...
// }
//
// void FGrid::Init(UWFC3DModelDataAsset* InWFCModel, const FIntVector& InDimension)
// {
// 	WFC3DModel = InWFCModel;
// 	Dimension = InDimension;
//
// 	if (WFC3DModel == nullptr)
// 	{
...
// 	{
// 		Grid[Index].Init(WFC3DModel->GetTileInfosNum(), WFC3DModel->GetFaceInfosNum(), Index, Dimension);
// 	}
...
// }
//
// void AWFCActor::Collapse()
// {
// 	Grid.CollapseGrid();
// }
//
// void AWFCActor::OnConstruction(const FTransform& Transform)
// {
// 	if (bInitGrid)
// 	{
// 		Init();
